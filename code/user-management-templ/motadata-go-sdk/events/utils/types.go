...
// Value returns the value if present, or the zero value of T otherwise.
// Use Get() to distinguish between "not present" and "present with zero value".
...
// Value returns the value if successful, or the zero value of T otherwise.
// Use Get() to retrieve both the value and the error.
