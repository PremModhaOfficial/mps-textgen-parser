...
func (h *Handler) HandleRegisterService(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleDeregisterService(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleQueryServices(ctx context.Context, msg *core.Message) error {
	var q Query
...
func (h *Handler) HandleDiscoverServices(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleRegisterInstance(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleDeregisterInstance(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleRenewInstance(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleQueryInstances(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleHealthUpdate(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) sendResponse(ctx context.Context, msg *core.Message, response any) error {
	if msg.Reply == "" {
	...
	replyMsg := core.NewMessage(data)
	replyMsg.Headers.Set("status", "success")

	return h.publisher.Publish(ctx, msg.Reply, replyMsg)
}

func (h *Handler) sendErrorResponse(ctx context.Context, msg *core.Message, err error) error {
	if msg.Reply == "" {
	...
	replyMsg := core.NewMessage(data)
	replyMsg.Headers.Set("status", "error")
