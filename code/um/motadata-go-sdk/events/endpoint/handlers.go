...
func (h *Handler) HandleRegister(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleDeregister(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleRenew(ctx context.Context, msg *core.Message) error {
...
func (h *Handler) HandleQuery(ctx context.Context, msg *core.Message) error {
	var q Query
...
func (h *Handler) HandleDiscover(ctx context.Context, msg *core.Message) error {
